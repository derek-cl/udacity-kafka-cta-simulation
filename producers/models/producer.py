...
class Producer:
    ...
    def __init__(
        ...
        self.broker_properties = {
            ...
            'POSTGRES_URL':'jdbc:postgresql://localhost:5432/cta',
            'DB_USER' : 'cta_admin',
            'DB_PASSWORD': 'chicago'
        ...
        if self.topic_name not in Producer.existing_topics:
            ...
            print(f'Topic exists: {self.topic_name}')
    ...
    def create_topic(self):
        ...
        for _, future in futures.items():
            try:
                ...
                print(f'Ignore error - Create topic failed: {e}')
    ...
    def close(self):
        ...
        # make sure all messages sent before closing down.
        self.producer.flush()
